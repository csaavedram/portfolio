        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4">
              <h3 className="text-2xl font-bold">{aboutInfo.name}</h3>
              <p className="text-gray-300 leading-relaxed">
                {aboutInfo.title} apasionado por crear experiencias web increíbles 
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center">
            <p className="text-gray-400">
              © {currentYear} {aboutInfo.name}. Todos los derechos reservados.
            </p>
            <p className="text-gray-500 text-sm mt-2">
              Construido con Next.js, TypeScript y Tailwind CSS ❤️
            </p>
          </div>
        </div>
      </div>
